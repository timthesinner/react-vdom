...
if (process.argv.indexOf('-dean') !== -1) {
  ...
  config.plugins = [
    ...
    new StaticSiteGeneratorPlugin(config.output.filename, ['/', '/static-bar-chart.html', '/dynamic-bar-chart.html', '404.html'], {
  ...
  config.plugins = [
    ...
    new webpack.optimize.CommonsChunkPlugin({name:'vendor', chunks: ['main'], warnings: false}),
